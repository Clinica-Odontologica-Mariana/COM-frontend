    ...
    <div class="min-h-full bg-[#F9F9F9]">
      <div class="mx-auto max-w-5xl px-6 py-10 lg:px-8">
        ...
        @if (loading()) {
          ...
          <div class="mb-10">
            <h1 class="font-serif text-3xl font-bold tracking-tight text-[#7C5145] md:text-4xl">
              Editar Agendamento
            </h1>
            <p class="mt-2 text-sm font-medium text-[#69594A]">
          ...
          <div class="grid gap-6 lg:grid-cols-3">
              ...
              <form [formGroup]="form" (ngSubmit)="onSave()">
                ...
                <div class="mb-8">
                  ...
                  <div class="flex items-center gap-4 rounded-xl bg-[#F3F3F3] p-4">
                    ...
                    <div>
                      <p class="font-serif text-xl font-bold text-[#7C5145]">
                ...
                <div class="mb-2">
                  <label class="mb-3 block text-sm tracking-widest text-[#78716C] uppercase"
                    >Status da Consulta</label
                  >
            ...
            <div class="rounded-3xl bg-[#7C5145] p-8 shadow-xl shadow-[#7C5145]/10">
              ...
              <button
                type="button"
                class="mt-6 flex items-center gap-2 border-b border-white pb-1 text-sm font-bold text-white"
              >
                <svg
                  class="h-3 w-3"
                  fill="none"
          ...
          <section class="mt-12 border-t border-[#E2E2E2] pt-12">
            ...
            <label class="mb-2 block text-sm font-medium text-[#514440]"
              >Notas Clínicas ou Logísticas</label
            >
            <textarea
          ...
          <!-- Footer actions -->
          <div
            class="mt-8 flex flex-wrap items-center justify-between gap-4 border-t border-[#E7E5E4] pt-8"
          >
            <button
              type="button"
    ...
    this.confirmDialog
      ...
      .subscribe(() => {
        this.appointmentService
          .delete(apt.id)
          .pipe(takeUntilDestroyed(this.destroyRef))
          .subscribe(() => void this.router.navigate(['/schedule']));
      });
  }
