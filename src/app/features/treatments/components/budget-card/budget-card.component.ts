...
@Component({
  ...
  template: `
    <div class="relative overflow-hidden rounded-4xl bg-[#7C5145] p-8">
      ...
      <div class="relative z-10">
        <p class="font-family-serif text-[20px] font-normal leading-snug text-white">
          Resumo do Orçamento
        </p>
        <p class="font-family-serif mt-3 text-[36px] font-bold leading-none text-white">
        ...
        <div class="grid grid-cols-2 gap-4">
          <div>
            ...
            <p class="font-family-sans mt-1 text-[18px] font-bold text-white">
