    ...
    <div class="min-h-screen bg-[#FBF8F5] text-[#5C5652]" style="font-family: 'Manrope', sans-serif">
      <section class="grid min-h-screen lg:grid-cols-[minmax(0,1.2fr)_minmax(26rem,0.8fr)]">
        <div class="relative hidden overflow-hidden bg-[#734C3E] lg:block">
          <div class="absolute inset-0 bg-[radial-gradient(circle_at_top_left,_rgba(248,231,212,0.5),_transparent_36%),linear-gradient(180deg,_rgba(119,76,60,0.18),_rgba(84,49,38,0.5))]"></div>
          <div class="absolute inset-0 bg-[linear-gradient(135deg,_rgba(255,255,255,0.08),_transparent_30%,_rgba(255,255,255,0.03)_60%,_rgba(55,26,18,0.2))]"></div>
          <div class="absolute -left-24 bottom-0 h-72 w-72 rounded-full bg-[#CFA186]/20 blur-3xl"></div>
          <div class="absolute right-0 top-0 h-96 w-96 rounded-full bg-[#EAD5C6]/15 blur-3xl"></div>
          <div class="absolute inset-0 bg-[linear-gradient(180deg,_rgba(33,20,14,0.08)_0%,_rgba(33,20,14,0.45)_100%)]"></div>

          <div class="relative flex h-full flex-col justify-between px-12 py-14 xl:px-16 xl:py-16">
            <div class="flex items-center gap-3 text-white/90">
              <img src="/Logo_clinica.svg" alt="Dra. Mariana" class="h-11 w-auto brightness-0 invert" />
            </div>
            ...
            <div class="max-w-xl space-y-4 text-[#F5E3D8]">
              <p class="text-2xl leading-relaxed italic xl:text-[2rem]" style="font-family: 'Noto Serif', serif">
                “A precisão da odontologia com o acolhimento do ambiente humano.”
              </p>
              <div class="space-y-1 text-sm font-semibold uppercase tracking-[0.28em] text-[#F8E8DE]/80">
                <p>Dra. Mariana</p>
                <p>Fundadora</p>
              </div>
        ...
        <div class="flex min-h-screen items-center justify-center px-6 py-12 sm:px-10 lg:px-12 xl:px-16">
          <div class="w-full max-w-116">
            ...
            <div>
              <div>
                ...
                <h1 class="mt-4 text-5xl font-bold leading-tight text-[#7C5145]" style="font-family: 'Noto Serif', serif">
                  Boas-vindas
                </h1>
              ...
              <form class="mt-12 space-y-7" [formGroup]="form" (ngSubmit)="submit()">
                <div class="space-y-3">
                  <label class="block text-sm font-semibold uppercase tracking-[0.2em] text-[#7E726C]">
                    E-mail
                  </label>
                  <div class="flex h-15 items-center rounded-full border border-[#E7D7CF] bg-white px-6 transition focus-within:border-[#B48A7C] focus-within:shadow-[0_0_0_4px_rgba(178,140,125,0.12)]">
                    <input
                      type="text"
                    ...
                    />
                    <svg viewBox="0 0 24 24" class="h-5 w-5 stroke-[#B28C7D]" fill="none" stroke-width="1.8">
                ...
                @if (errorMessage()) {
                  <div class="rounded-3xl border border-[#F1D5CC] bg-[#FFF6F2] px-5 py-4 text-sm leading-6 text-[#9A5E52]">
                    {{ errorMessage() }}
                  </div>
                }
              ...
              <div class="mt-10 border-t border-[#F0E2DB] pt-8">
                ...
                <div class="mt-8 flex items-center gap-6 text-xs font-semibold uppercase tracking-[0.24em] text-[#9B8F88]">
